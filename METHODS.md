...
### 단계
1. **유행 바스켓 정의**: 전국적으로 robust하게 상승한 메뉴 — 마라·두바이·탕후루·약과·
   그릭·바질·비건.
...
### 결과
광주(+0.46)·경북(+0.43)·충남(+0.35)·대구(+0.34)가 민감, 경남(−0.80)·서울(−0.36)이 둔감. 수도권
(−0.14) < 비수도권(+0.03), 서울 거리와 무관(r=+0.07, p=0.81) → **"도시=트렌드 리더" 통념 기각**
(수도권 둔감은 견고). 대형 유행(마라 CV 0.19)은 전국 균일, 틈새 유행(비건·바질·두바이)만 지역적.
단 **시도 1위 순위는 마라 단일 유행에 민감해 불안정** — 부트스트랩 1위 빈도 광주 33%·경북 21%·충남
16%·대구 12%(마라 제외 시 광주 40%로 더 견고, 대구는 9위로 후퇴). 견고한 건 광역 방향(수도권 둔감,
부트스트랩 90%; 마라 제외 93%)이며, §1 공간분석의 '매운맛=영남 핫스팟'과 결이 같다.
...
### 한계
바스켓이 마라에 다소 지배되지만, 견고한 결론은 **광역 방향(지방 민감 > 수도권/서울 둔감, 부트스트랩
90%)**이다. 시도별 1위 순위 자체는 마라 단일 유행에 민감해 불안정(부트스트랩 광주 33%). 시도(16) 단위라
시군구로 보강 여지. 경남이 영남인데 둔감한 점은 추가 분석 여지.
