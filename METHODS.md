...
### 결과
대구(+0.58)·경북·광주·울산이 민감(영남 선두), 경남(−0.70)·서울(−0.44)이 둔감. 수도권(−0.11) ≈
비수도권(+0.02), 서울 거리와 무관(r=0.04, p=0.89) → **"도시=트렌드 리더" 통념 기각.** 대형 유행
(마라 CV 0.19)은 전국 균일, 틈새 유행(비건 0.86·탕후루 0.79·두바이 0.45)만 지역적. 영남의 마라
주도는 §1 공간분석의 '매운맛=영남 핫스팟'과 교차검증된다.
