...
단 **시도 순위는 마라 단일 유행에 민감해 불안정** — 마라탕 이중계수를 빼면 1위는 광주, 대구는 4위
(부트스트랩 top-1 ~12%)로 후퇴한다. 견고한 건 광역 방향(수도권 둔감, 부트스트랩 89%)이며, §1
공간분석의 '매운맛=영남 핫스팟'과 결이 같다.
...
89%)**이다. 시도별 1위 순위 자체는 마라 단일 유행에 민감해 불안정(광주↔대구). 시도(16) 단위라
