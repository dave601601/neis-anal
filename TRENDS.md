...
| 트렌드는 서울·수도권이 먼저 | **광주·경북(지방)이 먼저**(발견3) | 입맛이 아니라 **예산** |
...
## 5. 발견 3 — 트렌드를 먼저 받는 건 서울이 아니라 지방 (이유는 예산)

> **통념**: 트렌드는 도시·수도권이 먼저 받는다. **데이터**: 광주·경북(지방)이 먼저고 서울은 둔감하다.
> **진짜 이유**: 입맛이 트렌디해서가 아니라 친환경 급식 '예산'이 지방에 더 많아서다.
...
3. **트렌드를 먼저 받는 건 도시가 아니다 — 예산이다.** 광주·경북(지방)이 서울보다 민감하다(수도권 둔감
   부트스트랩 90%). 입맛이 트렌디해서가 아니라 친환경 급식 예산이 지방에 더 많아서다.
