...
6. **사회 음식 트렌드의 리더는 수도권이 아니라 영남이다.** 유행 메뉴 바스켓(마라·두바이·
   탕후루·그릭…) 수용 지수가 대구(+0.58)·경북에서 최고, 서울(−0.44)·경남은 최저. 수도권 ≈
   비수도권이고 서울 거리와 무관(r=0.04, p=0.89) → "도시=트렌드 리더" 통념 기각. 대형 유행
   (마라)은 전국 균일, 틈새 유행(비건·탕후루)만 지역적. spatial #1의 '매운맛=영남'과 교차검증.
